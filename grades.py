...
if __name__ == '__main__':
    ...
    ap.add_argument('htmlfile', type=str, metavar='FILE', help="Your html file downloaded by saving "
                    "https://cn.inside.dtu.dk/cnnet/Grades/Grades.aspx")
    ap.add_argument('--outfile', type=str, metavar='FILE', help="Filename to save grades", default='grades.csv')
    args = ap.parse_args()
